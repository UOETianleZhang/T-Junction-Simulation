...
The Switch() function uses a switch to simulate the function of pedestrian button.
...
int timereg[20];	//integer array timereg[20] is to register the period in different states.
...
//This function uses a switch to simulate the function of pedestrian button.
